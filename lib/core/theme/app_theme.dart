...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        headlineMedium: const TextStyle(fontSize: 24, fontWeight: .bold, letterSpacing: 0.5, color: AppColors.textLight),
        titleMedium: const TextStyle(fontSize: 15, fontWeight: .bold, color: AppColors.textLight),
        titleSmall: GoogleFonts.inter(fontSize: 13, color: Colors.white),
        ...
        bodySmall: GoogleFonts.jetBrainsMono(fontSize: 12, fontWeight: .bold, color: AppColors.textHintLight, letterSpacing: 1),
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        titleSmall: GoogleFonts.inter(fontSize: 13, color: AppColors.textDark),
        bodyLarge: GoogleFonts.barlowCondensed(fontSize: 20, fontWeight: .bold, letterSpacing: 1, color: AppColors.textDark),
        bodyMedium: GoogleFonts.jetBrainsMono(fontSize: 12.5, fontWeight: .w500, color: AppColors.textDark),
        bodySmall: GoogleFonts.jetBrainsMono(fontSize: 12, color: AppColors.textHintDark),
        labelMedium: GoogleFonts.jetBrainsMono(fontSize: 11, fontWeight: .bold, color: AppColors.textHintDark, letterSpacing: 1),
        labelSmall: kDefaultlTextStyle,
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(style: kElevatedButtonDarkPrimary),
      iconButtonTheme: IconButtonThemeData(style: kIconButtonDarkPrimary),
